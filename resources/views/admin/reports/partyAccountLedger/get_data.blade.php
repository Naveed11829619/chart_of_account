                    ...
                    @foreach($vouchers as $key=>$detail)
                        @if($loop->first)
                            @php
                                ...
                                $getOpeningBalanceResponse = getOpeningBalance($detail->final_account_id, null, $startDate, true , $detail->id);
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td>{{ number_format(getOpeningBalance($detail->final_account_id, null, $startDate, true , $detail->id)["opening_balance"]) }}</td>
                                <td>{{ getOpeningBalance($detail->final_account_id, null, $startDate, true , $detail->id)["opening_balance_type"] }}</td>

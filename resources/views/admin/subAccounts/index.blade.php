            ...
            <div class="modal-body px-5">
               <div class="form-validation my-5">
                   <form class="form-valide" id="create-form">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label px-0" for="val-title">Accounts<span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="val-title" name="title" placeholder="Enter Accounts..">
                            </div>
                        </div>

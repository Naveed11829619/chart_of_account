                    ...
                    <form class="form-valide" id="create-form">
                        <div class="row m-0 justify-content-center">
                            <div class="text-center">
                                <h4 class="text-center" id="voucher_heading">Journal Voucher</h4>
                            </div>
                        ...
                        <div class="row align-items-end text-left">
                          ...
                          <div class="form-group1 row mb-0">
                                <label class="col-lg-6 col-form-label px-0" for="val-date">Voucher Date<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group1 row mb-0">
                                <label class="col-lg-12 col-form-label px-0" for="val-date">Voucher Type<span class="text-danger">*</span></label>
                                <div class="col-lg-12 pl-0 pr-2">
                                    <select name="voucher_type" id="type" class="form-control searchableSelect">
                                        <option selected disabled value="">Voucher Type</option>
                            ...
                            <div class="text-right col-lg-3">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".addsubaccount" onclick="initializeSelect2(), transactionSelect2()">Add Final account</button>
                            </div>
                        </div>
                                ...
                                <div class="row mx-0 justify-content-between">
                                    <div class="col-3 px-0">
                                        <div class="form-group row m-0 align-items-center">
                                            ...
                                            <div class="col-lg-12 pl-0 pr-2">
                                                <input class="form-control" id="credit_date" name="credit_dates[]" placeholder="dd/mm/yy" onkeyup="date_reformat_dd(this);" onkeypress="date_reformat_dd(this);" onpaste="date_reformat_dd(this);" autocomplete="off" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3 px-0">
                                        <div class="form-group row m-0 align-items-center">
                                            <label class="col-lg-12 col-form-label px-0">Final Account<span class="text-danger">*</span></label>
                                            <div class="col-lg-12 pl-0 pr-2">
                                                <select name="credit_accounts[]" class="form-control searchableSelectCredit pushSubAccount">
                                                    <option selected disabled value="">Final Account</option>
                                ...
                                <div class="row mx-0 justify-content-between">
                                    <div class="col-3 px-0">
                                        <div class="form-group row m-0 align-items-center">
                                            <label class="col-lg-12 col-form-label px-0">Date<span class="text-danger">*</span></label>
                                            <div class="col-lg-12 pl-0 pr-2">
                                                <input class="form-control" id="debit_date" name="debit_dates[]" placeholder="dd/mm/yy" onkeyup="date_reformat_dd(this);" onkeypress="date_reformat_dd(this);" onpaste="date_reformat_dd(this);" autocomplete="off" type="text">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="text-right">
                            <button type="button" class="btn btn-info text-white" onclick="commonFunction(false,'{{ url('journal_print_view') }}','','post','','create-form');">Print</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="form-validation my-5">
                    <form class="form-valide" id="create-form-sub">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label px-0" for="val-account">Level three Accounts<span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <select class="form-control searchableSelectSubAccount removeVal" id="val-account" name="level_three_id">
                                    <option value="" disabled selected>Select Final Accounts</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control removeVal" id="val-title" name="title" placeholder="
                                Final Accounts..">
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success text-white" onclick="addRealTimeFunction(false,'{{ route('final_account.store') }}', 'subAccount', 'post','','create-form-sub');">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const addNewRow = (elem, id, side, commonClass) => {
        ...
        $(`.searchableSelect${side}${count}`).select2({
            dropdownParent: $(`.searchableSelect${side}${count}`).parent()
        });
        // Initialize select2 in add more
    ...
    $(document).ready(function() {
        $("select#type").change(function() {
            ...
            $("#voucher_heading").text(selectedType);
        });
        $('.searchableSelectCredit').select2({
            dropdownParent: $('.searchableSelectCredit').parent()
        });
        $('.searchableSelectDebit').select2({
            dropdownParent: $('.searchableSelectDebit').parent()
        });
        $('.searchableSelectSuspense').select2({
            dropdownParent: $('.searchableSelectSuspense').parent()
        });

        $('.searchableSelectSubAccount').select2({
            dropdownParent: $('.searchableSelectSubAccount').parent()
        });
    ...
    function transactionSelect2() {
        $('.searchableSelectTransaction').select2({
            dropdownParent: $('.searchableSelectTransaction').parent()
        });
    }
...
var dateString = currentDate.getDate().toString().padStart(2, '0') + " / " + 
  ...
  $("#credit_date").val(dateString);
  $("#debit_date").val(dateString);
</script>

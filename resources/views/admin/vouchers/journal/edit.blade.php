                    ...
                    <div class="card-body px-4">
                        <form class="form-valide" id="update-form">
                                  ...
                                  {{-- Credit Section Start --}}
                                    <div  id="journal_credit" class="mt-3">
                                        ...
                                        <div class="row mx-0 justify-content-between">
                                            ...
                                            <div class="col-3 px-0">
                                                <div class="form-group row m-0 align-items-center">
                                                    <label class="col-lg-12 col-form-label px-0 pb-0">Final Account<span class="text-danger">*</span></label>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="form-group row m-0 align-items-center">
                                                            ...
                                                            <div class="col-lg-12 pl-0 pr-2">
                                                                <select name="credit_accounts[]" class="form-control updateSearchableSelectCredit{{ $detail->id }} pushSubAccount">
                                                                    <option selected value="">Final account</option>
                                                                    @foreach ($subAccounts as $subAccount)
                                                                        <option @if($subAccount->id==$detail->final_account_id) selected @endif value="{{$subAccount->id}}">{{$subAccount->title}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                            ...
                            <div class="text-right">
                                <a class="btn btn-info text-white" href="{{ url('printvoucher/'.$id) }}">Print Voucher</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
               ...
               <div class="form-validation my-5">
                   <form class="form-valide" id="create-form-sub">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label px-0" for="val-account">Select Sub Accounts<span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <select class="form-control searchableSelectSubAccount removeVal" id="val-account" name="level_three_id">
                                    <option value="" disabled selected>Select Sub Level Accounts</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control removeVal" id="val-title" name="title" placeholder="Enter Final Accounts..">
                            </div>
                        </div>
           ...
           <div class="modal-footer">
               ...
               <button type="button" class="btn btn-success text-white" onclick="addRealTimeFunction(false,'{{ route('final_account.store') }}', 'finalAccount', 'post','','create-form-sub');">Save</button>
            </div>
        </div>
    </div>
</div>

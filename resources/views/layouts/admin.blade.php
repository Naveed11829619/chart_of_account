    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ route('dashboard') }}" class="px-2">
                    <b class="logo-abbr">
                        <img src="{{asset('assets/img/logo.svg')}}" width="150">
                    </b>
                    <span class="brand-title">
                        <h5 class="text-white ml-3">Symbargo Digital - AMS</h5>
                    </span>
                </a>
            </div>
        </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            @can('view-sub-categories')
                                <li>
                                    <a href="{{ route('sub-accounts.index') }}">Accounts</a>
                                </li>
                            @endcan
                            <li>
                                <a href="{{ route('level3.index') }}">Sub Account</a>
                            </li>
                            <li>
                                <a href="{{ route('final_account.index') }}">Final Account</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            @can('')
                            <li>
                                <a href="{{ route('journal.create') }}">Create Voucher</a>
                            </li>
                            @endcan
                        </ul>
                    ...
                    @if (auth()->user()->can('') || auth()->user()->can(''))
                        <li>
                            ...
                            <ul aria-expanded="false">
                                ...
                                @can('')
                                <li>
                                    <a href="{{ route('journal.index') }}">Voucher List</a>
                                </li>
                                @endcan

                                @can('')
                                    <a href="{{url('final_report')}}">Final Account Report</a>
                                @endcan
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="https://www.ewdtech.com" target="_blank">EWD TECH</a>
                    2021</p>
            </div>
        </div>
        <!--**********************************
